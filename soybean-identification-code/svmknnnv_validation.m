function [accvector sensitivity,Cc,Cb,Bc,Bb] = svmknnnv_validation(tClassifier, matrix,damages,parameters,pfOut)
...
%        end
        ...
        if(strcmp(upper(tClassifier),'SVM')==1)
        	...
        	svmStruct = svmtrain(train_class, mtrain, parameters);
        ...
        elseif(strcmp(upper(tClassifier), 'KNN')==1)
            ...
            predicted_class = knnclassify(mtest, mtrain, train_class, parameters);
        ...
        elseif(strcmp(upper(tClassifier), 'NV')==1)
            ...
            object = NaiveBayes.fit(mtrain, train_class, 'Distribution', 'kernel');
            predicted_class = predict(object, mtest);
        end
